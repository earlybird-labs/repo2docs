...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Convert a GitHub repository .zip file into documentation."
    )
    parser.add_argument(
        "repo_zip_path", help="The path to the GitHub repository .zip file."
    )
    parser.add_argument(
        "output_file",
    ...
    parser.add_argument(
        ...
        help="Specify the type of documentation to generate (documentation or diagram).",
    )
    parser.add_argument(
        "--llm",
